...
export default function Signup() {
  ...
  const handleSignup = async (event) => {
    ...
    try {
      // TODO: integrate Supabase signup when backend URL and API are available.
        ...
        <section className="rounded-[2rem] bg-white p-8 shadow-[0_30px_80px_rgba(15,23,42,0.12)] sm:p-10">
          <div className="mb-10 max-w-xl">
            ...
            <p className="mt-4 text-sm leading-6 text-slate-500 sm:text-base">
              Sign up and start managing your next project with a clean, responsive auth experience.
            </p>
          </div>
        ...
        <aside className="hidden rounded-[2rem] bg-gradient-to-br from-slate-950 via-emerald-900 to-slate-700 p-10 text-white shadow-[0_30px_80px_rgba(15,23,42,0.16)] lg:block">
          <div className="space-y-6">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
              <p className="text-xs uppercase tracking-[0.28em] text-cyan-200">Built for creators</p>
              <h2 className="mt-4 text-3xl font-semibold">Easy account creation.</h2>
              <p className="mt-4 text-sm leading-6 text-slate-200">A modern signup page with clear inputs and friendly messaging.</p>
            </div>

            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                <p className="text-xs uppercase tracking-[0.3em] text-slate-300">Intuitive form</p>
                <p className="mt-2 text-sm leading-6 text-slate-200">Large fields and strong contrast make onboarding fast.</p>
              </div>
              <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                <p className="text-xs uppercase tracking-[0.3em] text-slate-300">Responsive layout</p>
                <p className="mt-2 text-sm leading-6 text-slate-200">Looks great on mobile, tablet, and desktop screens.</p>
              </div>
            </div>
          </div>
        </aside>
